...
-- Tiempo de generación: 06-08-2020 a las 21:13:16
...
INSERT INTO `city` (`ID`, `Name`, `CountryCode`, `District`, `Population`, `image`) VALUES
...
(4081, 'San Gregorio Atzompa', 'MLI', 'Tlaxcala', 2500, ''),
(4083, 'Tepeaca', 'MYT', 'Sinaloa', 35000, ''),
(4085, 'Amozoc de Mota', 'MEX', 'Puebla', 100000, 'amozoc-mota.jpg');
...
INSERT INTO `users` (`id_usuario`, `nombre`, `usuario`, `contrasena`, `fecha_registro`, `activo`) VALUES
(1, 'Juan Pérez', 'juanito@gmail.com', 'qwerty', '2020-08-05 00:00:00', 1);
...
--
ALTER TABLE `city`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4086;
